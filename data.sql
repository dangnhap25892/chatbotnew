...
CREATE TABLE `users` (
  ...
  `chatfuel` varchar(255) NOT NULL DEFAULT 0,
...
INSERT INTO `users` (`ID`, `trangthai`, `hangcho`, `ketnoi`, `gioitinh`,`chatfuel`,`token`) VALUES
(2208828715811317, 0, 0, NULL, 1,1,1),
(2885307244862831, 0, 0, NULL, 2,1,1);
